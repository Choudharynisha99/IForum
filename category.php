...
<!-- banner form -->
 ...
 <form enctype="multipart/form-data" method="post">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="ctdesc">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Upload</label>
    <input type="file" class="form-control" id="exampleInputPassword1" name="ctfile">
  </div>
  <div class="mb-3 form-check">
    <input type="checkbox" class="form-check-input" id="exampleCheck1">
    <label class="form-check-label" for="exampleCheck1">Check me out</label>
  </div>
  <button type="submit" class="btn btn-primary" name="ctadd">Add Category</button>
</form>
 </div>
<!-- banner form -->
...
if(isset($_REQUEST['ctadd'])){
  $name = $_POST['cname'];
  $desc = $_POST['ctdesc'];
  $fileok = $_FILES['ctfile'];
  ...
  // print_r($fileok);
        ...
        $img_name = $_FILES['ctfile']['name'];
      $img_typ = $_FILES['ctfile']['type'];
      $img_temp = $_FILES['ctfile']['tmp_name'];
      ...
      $query = mysqli_query($con, "INSERT INTO `category`(`category_name`, `category_desc`, `category_image`) VALUES ('$name','$desc','$finalImage')");
